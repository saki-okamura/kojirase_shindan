class DesperateAnalysisService
  ...
  def call
    words = ['コスメ', 'タワマン', '海外旅行', 'モテ', '綺麗', '可愛い', 'ネイル', '美容院', '髪', 'ダイエット', 'ジム', '筋トレ', 'メイク', 'プレゼント', 'CHANEL', 'コットン', 'GUCCI', '4℃', 'ロイヤルミルクティー', 'サイゼ', '指輪', '奢り', '奢られ', 'バレンタイン', 'ホワイトデー', 'クリスマス', 'バッグ', 'ネックレス', 'ブランド', 'シャネル', 'グッチ', 'ハイブラ', 'サプライズ', 'ファミレス']
    desperate = 0
    words.each do |word|
